...
public class DadosPessoaisController {
	...
	@PostMapping
	ResponseEntity<DadosPessoaisDTO> cadastraNovosDadosPessoais(@RequestBody DadosPessoaisDTO dadosPessoaisDTO) throws DadosPessoaisExcpetion{
		
		
		DadosPessoaisDTO dp = dadosPessoaisService.cadastraNovoDadoPessoais(dadosPessoaisDTO);
	...
	@GetMapping
	ResponseEntity<Page<DadosPessoaisDTO>> consultaTodosCadastrosPessoais(@RequestParam(defaultValue = "0") int page,
	...
	@GetMapping("/{id}")
	ResponseEntity<DadosPessoaisDTO> consultaCadastroPessoalPorId(@PathVariable Integer id)
	...
	@PutMapping("/{id}")
	ResponseEntity<DadosPessoaisDTO> atualizaDadosPessoais( @PathVariable Integer id, @RequestBody DadosPessoaisDTO dto) throws DadosPessoaisExcpetion{
	...
	@PatchMapping("/{id}")
	ResponseEntity<DadosPessoaisDTO> patchDados(@PathVariable Integer id, @RequestBody Map<String, Object> updates)
			throws DadosPessoaisExcpetion {
